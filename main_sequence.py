...
def calculation_sequence (file_path, running_status):
    ...
    if (sorted_control_valves) :  # control valve가 없는 경우도 많다.
        ...
        module_output_drawio.add_dataframe_to_layer(df_cv, root_elem, CalculationResult_layer_id, start_x=start_x, start_y=start_y, index_col_width=55, col_width=45, cell_height=15, font_size=9, max_cols=3, row_spacing=2)
    ...
    module_output_drawio.add_string_content_to_drawio (only_contents, root_elem, CalculationResult_layer_id, start_x=start_x, start_y=start_y, col_width=100, cell_height=100, font_size=10, box_name="pump_content_box")
    ...
    module_output_drawio.add_string_content_to_drawio (only_deviation, root_elem, CalculationResult_layer_id, start_x=start_x, start_y=start_y, col_width=400, cell_height=30, font_size=10, box_name="deviation_content_box")
